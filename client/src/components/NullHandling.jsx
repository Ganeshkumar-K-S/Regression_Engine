    ...
    <div className="-m-1.5 p-4 font-montserrat">
      ...
      <div className="relative overflow-x-auto rounded">
        ...
        <div className="absolute left-0 top-0 z-10 w-48 bg-[var(--color-honeydew-800)]">
          ...
          <div>
            {nullAttributes &&
              nullAttributes.map(([attr], idx) => (
                <div
                  key={idx}
                  className="px-6 py-4 whitespace-nowrap font-semibold text-sm text-chrysler-blue-700 bg-[var(--color-honeydew-800)] backdrop-blur-sm hover:bg-white/10 transition-colors flex items-center h-[57px]"
                >
                  {attr}
                </div>
              ))}
